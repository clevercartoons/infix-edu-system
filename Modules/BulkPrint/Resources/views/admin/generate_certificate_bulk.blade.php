                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mt-30-md classSection">
                            ...
                            <div class="">
                                <input type="checkbox" id="multipleClassCheckbox" class="common-checkbox">
                                <label for="multipleClassCheckbox" class="mt-3">@lang('common.select_all') </label>
                            </div>
                            @if ($errors->has('class'))
                                <span class="invalid-feedback invalid-select" role="alert">
                        ...
                        <div class="col-lg-4 mt-30-md gridGap">
                            <div class="input-effect">
                                ...
                                <label>@lang('admin.grid_gap')(px)</label>
