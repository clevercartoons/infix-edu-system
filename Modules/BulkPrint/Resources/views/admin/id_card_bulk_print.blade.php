                                                        ...
                                                        <div class="card_text_left hId">
                                                            ...
                                                            @if(moduleStatusCheck('University'))
                                                                @if($id_card->un_session==1)
                                                                    <div id="hSession">
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('university::un.session') : @foreach($staff_student->studentRecords as $record) 
