(function($) {
    ...
    addMoreEarnings = () => {
        ...
        var row = (table.insertRow(table_len).outerHTML =
            "<tr id='row" +
            id +
            "'><td width='70%' class='pr-30'><div class='input-effect mt-10'><input class='primary-input form-control' placeholder='"+jsLang('type')+"' type='text' id='earningsType" +
            id +
            "' name='earningsType[]'><label for='earningsType" +
            id +
            "'></label><span class='focus-border'></span></div></td><td width='20%'><div class='input-effect mt-10'><input class='primary-input form-control' type='number' placeholder='"+jsLang('value')+"' oninput='this.value = Math.abs(this.value)' id='earningsValue" +
            id +
    ...
    addDeductions = () => {
        ...
        var row = (table.insertRow(table_len).outerHTML =
            "<tr id='DeductionRow" +
            id +
            "'><td width='70%' class='pr-30'><div class='input-effect mt-10'><input class='primary-input form-control' placeholder='"+jsLang('type')+"' type='text' id='deductionstype" +
            id +
            "' name='deductionstype[]'><label for='deductionstype" +
            id +
            "'></label><span class='focus-border'></span></div></td><td width='20%'><div class='input-effect mt-10'><input class='primary-input form-control ' oninput='this.value = Math.abs(this.value)' type='number' placeholder='"+jsLang('value')+"' id='deductionsValue" +
            id +
    ...
    addRowLesson = () => {
        ...
        newRow += "<td class=''>";
        newRow += "<div class='input-effect pt-10'>";
        newRow +=
            "<input class='primary-input form-control' type='text' placeholder='title' id='lesson' name='lesson[]' autocomplete='off'>";
    ...
    addRowTopic = () => {
        ...
        newRow += "<div class='input-effect pt-10'>";
        newRow +=
            "<input class='primary-input form-control' type='text' placeholder='title' id='topic' name='topic[]' autocomplete='off'>";
   ...
   // add new row for class routine update by abuNayem
    ...
    //     var count;
    //     if (tableLength > 0) {
    //         tableRow = $("#classRoutineTable tbody tr:last").attr("id");
    //         arrayNumber = $("#classRoutineTable tbody tr:last").attr("class");
    //         count = tableRow.substring(3);
    //         count = Number(count) + 1;
    //         arrayNumber = Number(arrayNumber) + 1;
    //     } else {
    ...
    //             tr +=
    //                 "<div class='nice-select w-100 bb niceSelect form-control' tabindex='0'>";
    //             tr += "<span class='current'>Select Subject</span>";
    //             tr +=
    //                 "<div class='nice-select-search-box'><input type='text' class='nice-select-search' placeholder='Search...'></div>";
    //             tr += "<ul class='list'>";
    //             tr +=
    //                 "<li data-value='' data-display='Select Item' class='option selected'>Select Subject</li>";
    ...
    //                 "</tr>";
    //             if (tableLength > 0) {
    //                 $("#classRoutineTable tbody tr:last").after(tr);
    //             } else {
