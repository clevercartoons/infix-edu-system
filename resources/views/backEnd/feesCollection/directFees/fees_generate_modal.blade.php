              ...
              <div class="col-lg-12">
                  ...
                  <div class="row mt-25">
                      <div class="col-lg-12" id="sibling_class_div">
                          <div class="input-effect">
                              @if(moduleStatusCheck('University'))
                              <input oninput="numberMinZeroCheck(this)" class="primary-input form-control" type="text" max="{{discountFeesAmount($installment_id)}}" name="amount" value="{{discountFeesAmount($installment_id)}}" id="amount" required>
                              @elseif(directFees())
                              <input oninput="numberMinZeroCheck(this)" class="primary-input form-control" type="text" max="{{$balace_amount}}" name="amount" value="{{$balace_amount}}" id="amount" required>
                              @endif 
