...
<style type="text/css">
  ...
  <div class="container-fluid">
    @if(auth()->user()->role_id == 2 || auth()->user()->role_id == 3 )
        ...
        'method' => 'POST', 'enctype' => 'multipart/form-data', 'id'=>'addFeesPayment', 'name' => 'myForm']) }}
    @else 
                      ...
                      <div class="col-lg-6">
                              <div class="d-flex radio-btn-flex ml-40">
                                @if(auth()->user()->role_id != 2 && auth()->user()->role_id != 3)
                                  ...
                                  @if(directFees())  
                              @if(@$method['PayPal']->active_status == 1)
                              <div class="mr-30">
                              ...
                              @if(@$method['Stripe']->active_status == 1)
                              <div class="mr-30">
                              ...
                              @if(@$method['Paystack']->active_status == 1)
                              <div class="mr-30">
...
$(function () {
    ...
    var publisherKey = '{!! @$data['Stripe']->gateway_publisher_key !!}';
    var ccFalse = false;
