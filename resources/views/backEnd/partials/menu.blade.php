                                    ...
                                    <li class="nav-item active">
                                        <select class="niceSelect infix_theme_style" id="infix_theme_style">
                                            ...
                                            @foreach($styles as $style)
                                                <option value="{{$style->id}}" {{color_theme()->id == $style->id? 'selected' :''}}>{{$style->title}}</option>
                                            @endforeach
                                        </select>
                                    </li>
                                </ul>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex ml-10">
                                                            <div class="">
                                                                ...
                                                                @if (isset(Auth::user()->wallet_balance) && isMenuAllowToShow('wallet'))
                                                ...
                                                @if(auth()->user()->staff)
                                                    @if(auth()->user()->staff->parent_id)
                                                        ...
                                                        <li>
                                                            ...
                                                            @lang('common.VIEW_AS_Staff'){{ ' ('.strtoupper(auth()->user()->staff->previousRole->name.')') }}
                                                            </a>
                                                        </li>
                                                        @else
                                                        <li>
