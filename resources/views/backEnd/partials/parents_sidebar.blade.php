...
@if(userPermission(72) && menuStatus(72) && isMenuAllowToShow('academics'))
...
@if(userPermission(97) && menuStatus(97) && isMenuAllowToShow('lesson'))
...
@endif
@if(userPermission(73) && menuStatus(73) && isMenuAllowToShow('homework'))
...
@endif
@if(userPermission(75) && menuStatus(75) && isMenuAllowToShow('student_info'))
...
@endif
@if(userPermission(76) && menuStatus(76) && isMenuAllowToShow('examination'))
...
@if(userPermission(80) && menuStatus(80) && isMenuAllowToShow('leave'))
...
@endif
@if(userPermission(85) && menuStatus(85) && isMenuAllowToShow('communicate'))
...
@endif
@if(userPermission(86) && menuStatus(86) && isMenuAllowToShow('academics'))
...
@endif
@if(userPermission(87) && menuStatus(87) && isMenuAllowToShow('student_info') && isMenuAllowToShow('academics'))
...
@endif
@if(userPermission(88) && menuStatus(88) && isMenuAllowToShow('library'))
...
@endif
@if(userPermission(91) && menuStatus(91) && isMenuAllowToShow('transport'))
...
@endif
@if(userPermission(92) && menuStatus(92) && isMenuAllowToShow('dormitory'))
...
<!-- chat module sidebar -->
 ...
 @if(userPermission(910) && menuStatus(910) && isMenuAllowToShow('chat'))
