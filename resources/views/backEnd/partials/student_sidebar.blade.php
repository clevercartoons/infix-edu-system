...
@if (moduleStatusCheck('Wallet') == true && isMenuAllowToShow('wallet'))
...
@if(userPermission(800) && menuStatus(800) && isMenuAllowToShow('lesson'))
...
@endif
@if(userPermission(23) && menuStatus(23) && isMenuAllowToShow('homework'))
...
@endif
@if(userPermission(35) && menuStatus(35) && isMenuAllowToShow('student_info'))
...
@endif
@if(userPermission(36) && menuStatus(36) && isMenuAllowToShow('examination'))
...
@if (moduleStatusCheck('ExamPlan') == true && isMenuAllowToShow('examplan'))
...
@if(userPermission(39) && menuStatus(39) && isMenuAllowToShow('leave'))
...
@if(moduleStatusCheck('OnlineExam') == true || (userPermission(45) && menuStatus(45) && isMenuAllowToShow('online_exam')))
    <li data-position="{{menuPosition(45)}}" class="sortable_li">
        ...
        <ul class="list-unstyled" id="subMenuStudentOnlineExam">
            ...
            @if (moduleStatusCheck('OnlineExam') == false && isMenuAllowToShow('online_exam'))
...
@endif
@if(userPermission(48) && menuStatus(48) && isMenuAllowToShow('communicate'))
...
@endif
@if(userPermission(49) && menuStatus(49) && isMenuAllowToShow('academics'))
...
@endif
@if(userPermission(50) && menuStatus(50) && isMenuAllowToShow('academics'))
...
@endif
@if(userPermission(51) && menuStatus(51) && isMenuAllowToShow('library'))
...
@endif
@if(userPermission(54) && menuStatus(54) && isMenuAllowToShow('transport'))
...
@endif
@if(userPermission(55) && menuStatus(55) && isMenuAllowToShow('dormitory'))
