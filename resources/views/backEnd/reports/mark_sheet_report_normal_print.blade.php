                                ...
                                <div class="{{(resultPrintStatus('header'))? "logo_img": "logo_img custom_result_print"}}">
                                    ...
                                    @if(resultPrintStatus('image'))
                                        <div class="profile_thumb profile_100">
                                            <img class="report-admit-img" src="{{ file_exists(@$studentDetails->studentDetail->student_photo) ? asset($studentDetails->studentDetail->student_photo) : asset('public/uploads/staff/demo/staff.jpg') }}" alt="{{ $student_detail->studentDetail->full_name }}" width="100" height="100">
                                        </div>
                                    @endif
                                </div>
                            </td>
